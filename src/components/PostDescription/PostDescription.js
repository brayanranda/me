export default function PostDescription() {
    return(
        <>
            <p className="text-justify mx-auto w-7/12 pt-12 text-xl leading-8">
                ...
                of Lorem Ipsum. <br></br><br></br> Contrary to popular belief, Lorem Ipsum is not simply
                ...
                the undoubtable source. Lorem Ipsum comes from sections 1.10.32 <br></br><br></br> and
